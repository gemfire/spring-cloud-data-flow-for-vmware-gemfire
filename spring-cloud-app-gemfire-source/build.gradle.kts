...
publishingDetails {
  artifactName.set("spring-cloud-app-gemfire-source")
  longName.set("Spring Cloud Stream App Source for VMware GemFire")
  description.set("Spring Cloud Stream App Source For VMware GemFire")
}
